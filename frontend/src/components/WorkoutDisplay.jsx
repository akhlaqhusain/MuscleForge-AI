...
const SECTION_THEMES = [
  ...
  { bg: '#fffbeb', border: '#fde68a', icon: <img src="src/assets/warmup.png" alt="Warm-Up" />, label_color: '#92400e' },
  { bg: '#ecfdf5', border: '#6ee7b7', icon: <img src="src/assets/main_workout.png" alt="Main Workout" />, label_color: '#065f46' },
  { bg: '#eff6ff', border: '#bfdbfe', icon: <img src="src/assets/flexibility.png" alt="Flexibility" />, label_color: '#1e40af' },
  { bg: '#fdf4ff', border: '#e9d5ff', icon: <img src="src/assets/protip.png" alt="Pro Tip" />, label_color: '#6b21a8' },
]
